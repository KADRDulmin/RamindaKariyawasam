...
These sources regenerate the four targeted one-page A4 resumes while preserving the original resume's visual system: cream wave header, exact circular portrait crop, orange Cormorant Garamond headings, Manrope body text, two-column layout, and compact linked contact row.
...
Pass a variant ID to build one file only: `nodejs-typescript`, `ai-full-stack`, `nodejs-typescript-ai-full-stack`, or `java-enterprise`.
