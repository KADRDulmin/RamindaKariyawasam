...
(function () {
  ...
  function scrollReveal() {
    ...
    document.querySelectorAll('#board-about .section-head, #board-nsbm .section-head, #board-work .section-head, #board-toolkit .section-head, #board-contact .section-head').forEach(function (el) {
    ...
    var BOARDS = ['#board-about','#board-nsbm','#board-work','#board-toolkit','#board-contact'];
